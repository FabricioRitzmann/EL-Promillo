...
create table if not exists public.wallet_passes (
  ...
  wallet_skin text not null default 'apple',
  preview_mode text not null default 'horizontal',
...
alter table public.wallet_passes
  ...
  add column if not exists wallet_skin text not null default 'apple',
  add column if not exists preview_mode text not null default 'horizontal',
