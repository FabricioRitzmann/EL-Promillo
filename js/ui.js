...
export const ui = {
  ...
  addBusinessCategoryBtn: document.getElementById('add-business-category-btn'),
  addBusinessCategoryPanel: document.getElementById('add-business-category-panel'),
  newBusinessCategoryInput: document.getElementById('new-business-category-input'),
  confirmBusinessCategoryBtn: document.getElementById('confirm-business-category-btn'),
...
export const formElements = {
  ...
  logoThemeAutoBackground: document.getElementById('logo-theme-auto-background'),
  logoThemeAutoText: document.getElementById('logo-theme-auto-text'),
  logoThemeAutoSecondary: document.getElementById('logo-theme-auto-secondary'),
  logoThemeAnalyzeBtn: document.getElementById('logo-theme-analyze-btn'),
  logoThemeApplyBtn: document.getElementById('logo-theme-apply-btn'),
  logoThemeResetBtn: document.getElementById('logo-theme-reset-btn'),
...
export function getPassFormData() {
  ...
  return {
    ...
    designConfig: {
      ...
      foregroundColor: formElements.fg.value,
      labelColor: formElements.passkitLabelColor.value,
      primaryColor: formElements.bg.value,
      secondaryColor: formElements.logoThemeAutoSecondary?.checked ? formElements.passkitLabelColor.value : '',
      autoGeneratedFromLogo: Boolean(formElements.logoThemeAutoBackground?.checked || formElements.logoThemeAutoText?.checked || formElements.logoThemeAutoSecondary?.checked)
    },
    banner: {
